...
class CardView extends Component {
  ...
  changeCard(props, cardsArray, point) {
    ...
    this.setState({
      ...
      correct: this.state.correct + point,
  ...
  render() {
    ...
    if (chosenDeck == null) {
      ...
      const cardsArray = chosenDeck.cards.map(card => {
        return <Card key={card.q} card={card} />;
      });
      return (
        <div className="col-md-4 list-group card-view">
          ...
          <div className="button-row">
            <button
              ...
              onClick={() => this.changeCard(this.props, cardsArray, 1)}
            >
              &#10003;
            </button>
            <button
              className="button button2"
              onClick={() => this.changeCard(this.props, cardsArray, 0)}
            >
              &#10006;
            </button>
          </div>
          <div className="deck-title">
            ...
            <h6>
              Total Score: {this.state.correct} out of {this.state.total}
            </h6>
          </div>
        </div>
      );
      ...
      return (
        <div className="col-md-4 list-group card-view">
          <div
            className={`card-show ${!this.state.shuffledDeck.length
              ? "hover"
              : ""}`}
          >
          ...
          <div className="button-row">
            <button
              ...
              onClick={() =>
                this.changeCard(this.props, this.state.shuffledDeck, 1)}
            >
              &#10003;
            </button>
            <button
              ...
              disabled={!this.state.shuffledDeck.length}
              onClick={() =>
                this.changeCard(this.props, this.state.shuffledDeck, 0)}
            >
              &#10006;
            </button>
          </div>
