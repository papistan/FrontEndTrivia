    ...
    return [{
...

        {
            ...
            cards: [{
                ...
                {
                    q: 'Extracts a section of a string and returns a new string?',
                    a: 'slice()'
                },
                {
                    q: 'Adds and/or removes elements from an array?',
                    a: 'splice()'
                },
                {
                    q: 'Splits a String object into an array of strings by separating the string into substrings?',
                    a: 'split()'
                },
                {
                ...
                {
                    q: 'Joins all elements of an array into a string?',
                    a: 'join()'
                },
                {
                ...
                {
                    q: 'Converts a string to an integer?',
                    a: 'parseInt()'
                },
                {
                    q: 'Converts a string to a floating number?',
                    a: 'parseFloat()'
                },
                {
